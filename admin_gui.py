...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.btn_takePhoto = tk.Button(self.Frame1)
        ...
        self.btn_personRegister = tk.Button(self.Frame2)
        ...
        self.btn_deletePhotos = tk.Button(self.frame_manage)
        ...
        self.btn_Addphotos = tk.Button(self.frame_manage)
        ...
        self.btn_clrLog = tk.Button(self.frame_detectLog)
